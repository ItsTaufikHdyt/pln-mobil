                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="customRadio4" name="keperluan_id" value="1" class="custom-control-input" {{$data->keperluan_id == 1 ? 'checked' : ''}}>
                            <label class="custom-control-label" for="customRadio4">Dinas</label>
                        </div>
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="customRadio5" name="keperluan_id" value="2" class="custom-control-input" {{$data->keperluan_id == 2 ? 'checked' : ''}}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="customRadio4" name="bagian" value="1" class="custom-control-input" {{$data->bagian == 1 ? 'checked' : ''}}>
                            <label class="custom-control-label" for="customRadio4">REN</label>
                        </div>
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="customRadio5" name="bagian" value="2" class="custom-control-input" {{$data->bagian == 2 ? 'checked' : ''}}>
                            <label class="custom-control-label" for="customRadio5">JAR</label>
                        </div>
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="customRadio4" name="bagian" value="3" class="custom-control-input" {{$data->bagian == 3 ? 'checked' : ''}}>
                            <label class="custom-control-label" for="customRadio4">TEL</label>
                        </div>
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="customRadio5" name="bagian" value="4" class="custom-control-input" {{$data->bagian == 4 ? 'checked' : ''}}>
                            <label class="custom-control-label" for="customRadio5">SAR</label>
                        </div>
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="customRadio5" name="bagian" value="5" class="custom-control-input" {{$data->bagian == 5 ? 'checked' : ''}}>
                            <label class="custom-control-label" for="customRadio5">KUM</label>
                        </div>
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="customRadio5" name="bagian" value="6" class="custom-control-input" {{$data->bagian == 6 ? 'checked' : ''}}>
                            <label class="custom-control-label" for="customRadio5">K3L</label>
                        </div>
                        <div class="custom-control custom-radio mb-5">
                            <input type="radio" id="customRadio5" name="bagian" value="7" class="custom-control-input" {{$data->bagian == 7 ? 'checked' : ''}}>
